...
\begin{frame}
  ...
  \begin{minipage}[t]{0.5\textwidth}}
    \begin{figure}
      ...
      a simplex-vertex}}
      \center
      \includegraphics[height=2.5cm]{d3c3_2_vertice.png}
    \end{figure}
  \mode<presentation>{\end{minipage}}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
	...
	\center
	\includegraphics[height=2.5cm]{d3c3_2_splitting1.png}
      \end{figure}
	...
	\center
	\includegraphics[height=2.5cm]{d3c3_2_splitting2_alt1.png}
	\hspace{0.1\textwidth}
	\includegraphics[height=2.5cm]{d3c3_2_splitting2_alt2.png}
      \end{figure}
  \end{itemize}
\end{frame}
...
\begin{frame}[plain]
  ...
  \href{http://math.bme.hu/~boroczki/D-symbols-edge-transitive/d3c6/20.html}{my
  homepage.} }}
  \mode<article>{Figure \ref{fig:d3c6_20}. looks like a screenshot, let's see
  the original at
  \href{http://math.bme.hu/~boroczki/D-symbols-edge-transitive/d3c6/20.html}{my
  homepage.}
  ...
  \begin{figure}
    \mode<article>{\caption{\label{fig:d3c6_20} 20th D-symbol with cardinality 6
    in 3D}}
    \center
    \includegraphics[width=0.5\textwidth]{d3c6_20.png}
    \hspace{0.1\textwidth}
    \includegraphics[width=0.3\textwidth]{d3c6_20.pdf}
  \end{figure}
\end{frame}
